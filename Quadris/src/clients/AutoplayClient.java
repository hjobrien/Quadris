...
//  public static final BlockGenerator GENERATOR = new RandomizeBlocks();
  ...
  // best game for StandardizeBlocks(2) and weights = -57.29, -83.97, 1.76, 1573.34, 2451.18,
  // 2089.19, 6228.07

  @Override
  public void start(Stage arg0) throws Exception {
    Game game = new Game(GAME_HEIGHT, GAME_WIDTH, MIN_TIME_PER_TURN, MAX_GAMES_TO_PLAY,
        GameMode.AUTOPLAY, USE_GRAPHICS, DEBUG, GENERATOR,
        new double[] {-57.29, -83.97, 1.76, 1573.34, 2451.18, 2089.19, 6228.07}, SCORE_MODE,
        NUM_BLOCKS_TO_ANALYZE);
    game.run(arg0);
