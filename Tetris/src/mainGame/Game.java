...
public class Game extends Application {
  ...
  private ArrayList<Integer> highScores = null; // need to put this here because i can't make a
  ...
  public void start(Stage stage) throws Exception {
    ...
    stage.addEventFilter(KeyEvent.KEY_PRESSED, e -> {
      if (e.getCode() == KeyCode.ESCAPE) {
        ...
        updateHighScores(score, highScores); // updates ArrayList by reference, can't do it well
