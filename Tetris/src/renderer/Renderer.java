...
/**
 * class that handles graphical output of all kinds from the game when run in
 * graphical mode this includes drawing the board, updating the score, and
 * keeping track of all-time top scores
 * 
 * @author Hank O'Brien
 *
 */
public class Renderer {
	...
	public static final Rectangle[][] MAIN_BOARD_RECTS = new Rectangle[VERTICAL_TILES][HORIZONTAL_TILES];
	 ...
	 * 
	 * @param doDebug
	 *            whether the object should print out its debug information
	 * @param doLog
	 *            whether the object should log its behavior
	 */
	...
	/**
	 * updates the status of all graphical things, including drawing the game
	 * boards
	 * 
	 * @param score
	 *            the score to display
	 * @param numFullRows
	 *            the number of full rows the engine has cleared
	 * @param hasFullBoard
	 *            if the engine has a full board
	 * @param gameBoard
	 *            the board to draw as the main game board
	 * @param nextBoard
	 *            the board to draw as the next piece board
	 */
	 ...
	 * 
	 * @param rects
	 *            the Rectangle array to initialize
	 */
	 ...
	 * 
	 * @return A Scene containing the relevant StackPanes and GridPanes, its the
	 *         main Scene
	 * @throws IOException
	 *             if file generation can't find a file or otherwise
	 */
	 ...
	 * 
	 * @param highScores
	 *            a list of the historical high scores
	 ...
	 * 
	 * @param s1
	 *            a key to be pressed (e.g. DOWN)
	 * @param s2
	 *            the result of the key press (e.g. block down)
	 ...
	 * 
	 * @param highScores
	 *            the list of historical high scores
	 ...
	 * @param numOfFullRows
	 *            the number of complete rows the user has created (and have
	 *            then been cleared)
	 */
	 ...
	 * 
	 * @throws IOException
	 *             for various file issues including FileNotFound
	 */
	 ...
	 * 
	 * @param fileReader
	 *            a Scanner on the high scores file
	...
	public void writeScores() {
		...
		if (!highScores.isEmpty()) {
			// so we don't indent after the last score was printed
			scorePrinter.print(highScores.get(highScores.size() - 1));
		}
	}

	/**
	 * updates the scores with the new score from the just-ended game and trims
	 * the list to keep it within 10 highscores
	 * 
	 * @param score
	 *            the new score to add
	 */
	...
	/**
	 * draws the two boards to the screen by updating the color of the
	 * rectangles
	 * 
	 * @param gameBoard
	 *            the mainGame to draw
	 * @param nextPieceBoard
	 *            the nextBoard to draw
	 */
	...
	public StackPane makeEndgameGraphic() {
		...
		// text.setStyle(
		// "-fx-font: 90 Arial; -fx-text-fill: rgb(100,100,100);
		// -fx-font-weight: bold; -fx-font-style: italic;");
		// GridPane endgameGraphic = new GridPane();
		//
		// endgameGraphic.getColumnConstraints().add(new
		// ColumnConstraints(GAME_WIDTH));
		// endgameGraphic.getColumnConstraints().add(new
		// ColumnConstraints(SCREEN_WIDTH - GAME_WIDTH));
